      ...
      <AppLayout>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">You don't have permission to access the cashdesk.</p>
          </div>
        </div>
      </AppLayout>
    );
      ...
      <AppLayout>
        <div className="space-y-6">
          <div>
            ...
            <p className="text-muted-foreground">Start your cashier session to begin processing sales</p>
          </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">₦{currentSession.openingFloat.toFixed(2)}</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">₦{currentSession.totalSales.toFixed(2)}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                ₦{(currentSession.openingFloat + currentSession.totalSales).toFixed(2)}
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {Math.floor((Date.now() - new Date(currentSession.startTime).getTime()) / (1000 * 60 * 60))}h
              </div>
